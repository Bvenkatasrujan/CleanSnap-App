...
const MyReportsScreen = () => {
  ...
  // ✅ Remove deleted report from list instantly
...
const styles = StyleSheet.create({
  ...
  logoutBtnLargeText: { fontSize: 15, color: '#EF4444', fontWeight: '700' },
  floatingLogout: {
  ...
  floatingLogoutText: { fontSize: 14, color: '#EF4444', fontWeight: '700' },
});
